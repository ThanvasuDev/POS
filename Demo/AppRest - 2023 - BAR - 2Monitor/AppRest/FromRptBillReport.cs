...
namespace AppRest
{
    public partial class FromRptBillReport : Form
    {
        ...
        public int rptBill = 0;
        public int rptType = 0;



        public FromRptBillReport(Form frmlkFrom, int flagFrmClose, int billID, int type)
        {
            InitializeComponent();
            if (flagFrmClose == 1)
            {
        ...
        public void viewReport()
        {
            ...
            if (rptType == 1)
                reportName = "Rpt_PrintBill_2.rpt";
            else if (rptType == 2)
                reportName = "Rpt_PrintBill_2_Copy.rpt"; 
            else if (rptType == 3)
                reportName = "Rpt_PrintBill_Cash.rpt";
            else if (rptType == 4)
                reportName = "Rpt_PrintBill_Delivery.rpt";
            else if (rptType == 11)
                reportName = "Rpt_PrintBill.rpt";
            else if (rptType == 12)
                reportName = "Rpt_PrintBill_Copy.rpt";
            else if (rptType == 13)
                reportName = "Rpt_PrintBillNew.rpt";
            else if (rptType == 14)
                reportName = "Rpt_PrintBillNew_Deposit.rpt"; 
            ...
            rd.SetParameterValue("@BillNo", rptBill);
